...
Run explicitly with: pytest -m manual tests/integration/test_server_integration.py
"""
...
class TestBackendIntegration:
    ...
    def test_cors_headers_present(self, running_server):
        ...
        response = httpx.options(
            f"{running_server.base_url}/api/auth/register", headers={"Origin": "http://localhost:3001"}
        )
