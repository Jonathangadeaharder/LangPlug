...
async def test_Whenuser_registration_login_and_meCalled_ThenSucceeds(async_client):
...
@pytest.mark.anyio
@pytest.mark.timeout(30)
async def test_Whenlogout_invalidates_tokenCalled_ThenSucceeds(async_client):
