...
class TestVocabularyServiceArchitecture:
    ...
    async def test_facade_delegates_to_query_service(self):
        ...
        service.query_service.get_word_info = AsyncMock(return_value={
            "found": True,
            "word": "test",
            "lemma": "test"
        })
    ...
    async def test_facade_delegates_to_progress_service(self):
        ...
        service.progress_service.mark_word_known = AsyncMock(return_value={
            "success": True,
            "word": "test",
            "is_known": True
        })
        ...
        service.progress_service.mark_word_known.assert_called_once_with(
            123, "test", "de", True, mock_db
        )
    ...
    async def test_facade_delegates_to_stats_service(self):
        ...
        service.stats_service.get_vocabulary_stats = AsyncMock(return_value={
            "target_language": "de",
            "levels": {},
            "total_words": 100,
            "total_known": 50
...
class TestBackwardCompatibility:
    ...
    async def test_legacy_method_signatures_work(self):
        ...
        service.query_service.get_vocabulary_library = AsyncMock(return_value={
