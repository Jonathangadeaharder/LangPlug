...
# Password hashing configuration - use bcrypt with strong settings
pwd_context = CryptContext(
    schemes=["bcrypt"],
    deprecated="auto",
    bcrypt__rounds=12,  # Increase from default 12 for better security
)
...
# Global instance for tracking login attempts
