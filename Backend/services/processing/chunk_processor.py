...
class ChunkProcessingService:
    ...
    async def process_chunk(
        ...
        try:
            ...
            self._complete_processing(task_id, task_progress)
    ...
    def _debug_empty_vocabulary(self, filter_result: Dict[str, Any], srt_file_path: str) -> None:
        ...
        logger.warning(f"[CHUNK DEBUG] ❌ NO BLOCKING WORDS FOUND - checking why...")
    ...
    def _complete_processing(self, task_id: str, task_progress: Dict[str, Any]) -> None:
