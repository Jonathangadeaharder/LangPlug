...
class SetupManager:
    ...
    def setup_backend_venv(self):
        ...
        self.run_command([str(self.python_exe), "-m", "pip", "install", "-U", "pip", "wheel"])
    ...
    def setup_frontend(self):
        ...
        elif (self.frontend_dir / "package-lock.json").exists() or (self.frontend_dir / "package.json").exists():
    ...
    def run_code_checks(self):
        ...
        try:
            ...
            self.run_command([str(self.python_exe), "-m", "pytest", "-q", "-m", "not slow and not performance"])
    ...
    def print_usage_info(self):
        ...
        print(f"  cd {self.backend_dir}")
        print(f"  {self.python_exe} -m uvicorn core.app:app --host 0.0.0.0 --port 8000 --reload")
