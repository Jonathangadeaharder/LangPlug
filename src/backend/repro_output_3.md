2025-11-30 17:52:02 [warning  ] slowapi not installed - rate limiting disabled. Install with: pip install slowapi==0.1.9
Starting reproduction script...
2025-11-30 17:52:02 [warning  ] LANGPLUG_ADMIN_PASSWORD environment variable not set. Please set a strong password for the admin account. Using a temporary secure password for this session.
2025-11-30 17:52:02 [info     ] Temporary admin password generated - check logs securely
2025-11-30 17:52:02 [info     ] Default admin user created (username: admin, email: admin@langplug.com). Password from LANGPLUG_ADMIN_PASSWORD environment variable.
...
2025-11-30 17:52:02 [info     ] Seeded 3 users from TEST_DATA
