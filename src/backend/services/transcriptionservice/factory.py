...
1. **Multiple Active Implementations**:
   - Whisper (OpenAI) - 6 model variants (tiny, base, small, medium, large, turbo)
   - Parakeet (NVIDIA) - 4 model variants (TDT/CTC 0.6B/1.1B)
   - Selection via environment variable: LANGPLUG_TRANSCRIPTION_SERVICE
...
4. **Environment-Based Selection**:
   - Test environment: whisper-tiny (fast, 39M params)
   - Production: whisper-large-v3-turbo (accurate, 809M params)
