...
// TypeScript declarations for custom matchers (Vitest-compatible)
// Custom matchers are defined in expect.extend() calls
// No global namespace declaration needed for Vitest
