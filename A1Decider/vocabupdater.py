...
Please use vocabupdater_pipeline.py instead.
...
def main():
    ...
    console.print(Panel(
        ...
        "This script has been refactored to use the ProcessingPipeline architecture.\n"
        "Please use [bold cyan]vocabupdater_pipeline.py[/bold cyan] instead.\n\n"
    ...
    try:
        ...
        pipeline_script = os.path.join(script_dir, "vocabupdater_pipeline.py")
        ...
        if os.path.exists(pipeline_script):
            ...
            console.print("[bold red]Pipeline version not found. Please run vocabupdater_pipeline.py manually.[/bold red]")
            sys.exit(1)
            
    except Exception as e:
        console.print(f"[bold red]Error launching pipeline version: {e}[/bold red]")
        console.print("[bold yellow]Please run vocabupdater_pipeline.py manually.[/bold yellow]")
        sys.exit(1)
